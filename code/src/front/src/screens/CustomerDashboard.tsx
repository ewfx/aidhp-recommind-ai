                ...
                {[
                  ...
                  <div key={i} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center">{tx.icon}</div>
                      <div>
                    ...
                    <p className={`font-medium ${tx.amount.startsWith("+") ? "text-green-600" : "text-gray-800"}`}>{tx.amount}</p>
                  </div>
                ))}
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="bg-white p-3 rounded-lg border border-blue-100">
                  ...
                  <button className="w-full bg-blue-600 text-black py-1.5 rounded-md text-sm font-medium">Learn More</button>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                ...
                <button className="w-full bg-yellow-600 text-black py-2 rounded-md text-sm font-medium">Explore Home Buying Options</button>
              </div>
            </CardContent>
          </Card>
